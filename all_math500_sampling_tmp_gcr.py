...
model_results = {
    ...
    #     'fix_bucket_cdf': FIX_BUCKET_CDF,
    #     'bucket_step': BUCKET_STEP,
    #     'run_output_dir': '/mnt/qilongma/inf_scal_law/results/QwQ-32B-Preview/MATH500/sampling/12-24_04-39',
    # },
    "Qwen2.5-32B-Instruct": {
        ...
        'fix_bucket_cdf': FIX_BUCKET_CDF,
        'bucket_step': BUCKET_STEP,
        'run_output_dir': '/mnt/qilongma/inf_scal_law/results/Qwen2.5-32B-Instruct/MATH500/sampling/01-07_01-14',
    },
    # "Llama-3.1-8B-ft": {
    #     'code': local_code,
    #     'n_problem': min(500, N_PROBLEM),
    ...
    #     'fix_bucket_cdf': FIX_BUCKET_CDF,
    #     'bucket_step': BUCKET_STEP,
    #     'run_output_dir': '/mnt/qilongma/inf_scal_law/results/Llama-3.1-8B-ft/MATH500/sampling/12-24_01-59',
    # },
    ...
    #     'fix_bucket_cdf': FIX_BUCKET_CDF,
    #     'bucket_step': BUCKET_STEP,
    #     'run_output_dir': '/mnt/qilongma/inf_scal_law/results/Llama-3.1-8B-qwq_math_sft-random/MATH500/sampling/01-02_00-32',
    # },
    "Llama-3.1-8B-qwq_math_sft-long": {
        ...
        'fix_bucket_cdf': FIX_BUCKET_CDF,
        'bucket_step': BUCKET_STEP,
        'run_output_dir': '/mnt/qilongma/inf_scal_law/results/Llama-3.1-8B-qwq_math_sft-long/MATH500/sampling/01-02_00-45',
    },
    ...
    #     'fix_bucket_cdf': FIX_BUCKET_CDF,
    #     'bucket_step': BUCKET_STEP,
    #     'run_output_dir': '/mnt/qilongma/inf_scal_law/results/Llama-3.1-8B-qwq_math_sft-short/MATH500/sampling/01-02_00-40',
    # },
}
